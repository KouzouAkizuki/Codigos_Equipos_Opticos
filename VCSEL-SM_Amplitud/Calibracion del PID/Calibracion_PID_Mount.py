# -*- coding: utf-8 -*-
"""
Created on Thu Sep 28 20:56:00 2023
...
Pshare_mount=2.5                 #Constante proporcional del PID de temperatura para la montura
Dshare_mount=2.5                  #Constante derivativa del PID de temperatura para la montura
Ishare_mount=2.5                 #Constante integrativa del PID de temperatura para la montura
Ishare_Status_mount='OFF'        #Activacion de la constante integrativa para la montura
...
#Debido a que lo ultimo que se configuro es la montura el SLOT corresponde al #2, por ende los comandos se aplican a ese SLOT

###### Inicia el TEC en una temperatura Inicial
Basic_Temp_Set(Isource,temp_start,temp_tol_mount)
...
####################### Data to .csv ##########################
filename = "VCSEL_1550_SM_PID_"+dt_string+"_Pshare_"+str(Pshare_mount)+"_Dshare_"+str(Dshare_mount)+"_Ishare_"+str(Ishare_mount)+"_Ishare_Status_"+Ishare_Status_mount+"_Tiempo_"+str(Segundos)+".csv"
