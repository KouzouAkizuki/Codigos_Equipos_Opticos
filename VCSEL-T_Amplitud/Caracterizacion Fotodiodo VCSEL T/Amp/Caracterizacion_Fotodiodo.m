...
for i=1:40
    Fotodiodo_SSFBG_DATA(:,:,i)=table2array(Fotodiodo_No_Amp('SSFBG_AMP_DAQ\Fotodiodo_FGA01FC_17_11_2023_16h_20m_Temp_VCSEL_T_562_Voltaje_Step_1_DAQ_OPM'+string(i)+'.csv'));
end
...
for i=1:40
    Fotodiodo_REF_DATA(:,:,i)=table2array(Fotodiodo_No_Amp('REF_AMP_DAQ\Fotodiodo_FGA01FC_17_11_2023_16h_38m_Temp_VCSEL_T_562_Voltaje_Step_1_DAQ_OPM'+string(i)+'.csv'));
end
...
f200=figure();
plot(Fotodiodo_SSFBG_mean_DATA(:,4),Fotodiodo_SSFBG_mean_DATA(:,3),'LineWidth',4,'Color','#00009B')

%potencia=0.0627077404*v-0.0017714024402        -> SSFBG
%Potencia=0.06157678362*v+0.007068472567        -> REF
