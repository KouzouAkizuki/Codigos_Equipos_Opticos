...
####################### Data to .csv ##########################
filename = "Interrogacion_VCSEL_1550_SM_"+dt_string+"_Temp_"+str(temp_start)+"_Current_Step_"+str(current_step)+"_DAQ_"+str(average_daq)+".csv"
...
for i in range(len(Tension_Referencia)):
    Procesamiento.append(Tension_SSFBG[i]/Tension_Referencia[i])

plt.plot(Corriente, Procesamiento)
plt.show()